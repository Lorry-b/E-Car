...
Car.create(brand: "BMW i4 xDrive40", category: "Sedan", price: 248, location: "Sainte-Catherine street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url: "https://hips.hearstapps.com/hmg-prod/images/bmw-i4-2-646bd10fe7fb4.jpg?crop=0.704xw:0.528xh;0.139xw,0.324xh&resize=1200:*")
Car.create(brand: "Mercedes-Benz EQB", category: "SUV", price: 260, location: "Saint-Laurant street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url:"//www.topgear.com/sites/default/files/2022/03/Large-40342-EQB.jpg")
...
Car.create(brand: "Subaru Solterra VUS", category: "SUV", price: 168, location: "Ontario street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url: "https://img.sm360.ca/images/article/groupelacasse/94197//subaru-solterra-header1637204981779.jpg")
...
Car.create(brand: "Audi A3 Technik", category: "Sedan", price: 136, location: "Mont-Royal Avenue, Toronto", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url:"https://saltwire.imgix.net/2022/5/26/wheels-car-review-2022-audi-s3-technik-invites-you-to-join-i_HLCHruX.jpg?cs=srgb&fit=crop&h=568&w=847&dpr=1&auto=enhance%2Cformat%2Ccompress")
Car.create(brand: "Tesla Model Y VUS", category: "SUV", price: 278, location: "Berri Street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url:"https://www.autoaubaine.com/actualite-automobile/images-automobiles/55811.jpg")
Car.create(brand: "Tesla Model 3", category: "Sedan", price: 200, location: "Crescent Street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url:"https://hips.hearstapps.com/hmg-prod/images/2019-tesla-model3-lt-airporthero-low-101-1587061146.jpg?crop=1.00xw:1.00xh;0,0&resize=2048:*" )
Car.create(brand: "Volkswagen e-Golf", category: "Hatchback", price: 130, location: "Saint-Denis Street, Montreal", start_availability:"2024/01/01", end_availability:"2024/12/31", user:User.first, picture_url: "https://hips.hearstapps.com/hmg-prod/images/db2017au00888-large-1583171843.jpg")
